...
public class JedisTools {
     ...
     * @param mapString 存储对象
     * */
    public void putMapObject(String key,Map<String,Object> mapString) throws Exception{
     ...
     * @param seconds 有效时间单位为秒 ,当seconds 为null时默认永不失效
     * */
    public void putMapObject(String key, Map<String, Object> mapString, Integer seconds) throws Exception{
    	Jedis jedis = null;
		try{
			if(StringUtils.isBlank(key)) return ;
			jedis = jedisPoolOperator.getJedis();
